...
export const ThemeToggleButton = ({
  ...
  if (!mounted) {
    return (
      <button
        className={cn(
          'relative overflow-hidden transition-all flex items-center justify-center opacity-50 cursor-not-allowed',
          showLabel && 'gap-2',
          className
        )}
        disabled
  ...
  return (
    <button
      onClick={handleClick}
      className={cn(
        'relative overflow-hidden transition-all flex items-center justify-center opacity-100 cursor-pointer hover:opacity-80',
        showLabel && 'gap-2',
        className
      )}
