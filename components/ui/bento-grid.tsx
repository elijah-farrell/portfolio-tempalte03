...
export const BentoGridItem = ({
  ...
  return (
    <div
      className={cn(
        "group/bento shadow-sm row-span-1 flex flex-col justify-between space-y-4 rounded-xl border border-border bg-card p-4 transition duration-200 hover:shadow-md",
        className,
      )}
    >
      {header}
