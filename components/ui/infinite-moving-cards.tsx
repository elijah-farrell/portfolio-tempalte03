  ...
  return (
    ...
    >
      ...
      >
        {items.map((item, idx) => (
          <li
            className="w-[260px] max-w-full relative rounded-2xl border border-gray-100 dark:border-[#2a2a2a] bg-[#F8FAFB] dark:bg-[#0A0A0A] px-6 py-5 md:w-[300px] opacity-0 animate-fade-in flex flex-col"
            style={{
              background:
