...
export function DiagonalStripes() {
  ...
  return (
    <>
      ...
      <div 
        className="absolute -left-[32px] top-0 w-[32px] h-full border-l border-r shadow-sm overflow-hidden"
        style={{
      ...
      <div 
        className="absolute -right-[32px] top-0 w-[32px] h-full border-l border-r shadow-sm overflow-hidden"
        style={{
          borderLeftColor: currentTheme === 'dark' ? '#2a2a2a' : '#f5f5f5',
          borderRightColor: currentTheme === 'dark' ? '#2a2a2a' : '#f5f5f5',
          boxShadow: currentTheme === 'dark' 
